...
export const toolI18n: Record<string, {
  ...
  totp: {
    ...
    ui: {
      zh: { secretKey: '密钥', addAccount: '添加账户', accountName: '账户名称', issuer: '发行者', placeholder: '粘贴 TOTP 密钥或 otpauth:// URI…', countdown: '倒计时', copyCode: '复制验证码', delete: '删除', showCode: '显示验证码', hideCode: '隐藏验证码', setupGuide: '使用说明', step1: '进入账户安全设置', step1Desc: '登录要开启两步验证的服务，找到安全设置页面。', step2: '选择「身份验证器」', step2Desc: '选择"认证器应用"作为验证方式，会显示一个二维码或密钥。', step3: '导入二维码或密钥', step3Desc: '截图保存二维码图片，拖拽到下方区域；或点击"无法扫描二维码"复制 Base32 密钥粘贴到输入框。', step4: '查看验证码', step4Desc: '导入成功后自动生成 6 位验证码，每 30 秒自动刷新。', services: '常见服务', history: '历史记录', importQr: '从二维码图片导入', qrHint: '拖拽图片、点击选择或粘贴 (Ctrl+V)', scanning: '正在扫描二维码…', orText: '或', conceptTitle: '概念介绍', whatIs2fa: '什么是两步验证 (2FA)？', whatIs2faDesc: '两步验证为你的账户增加第二层安全保护。即使密码被盗，攻击者也无法在没有动态验证码的情况下登录你的账户。', howItWorks: 'TOTP 工作原理', howStep1: '共享密钥', howStep1Desc: '开启 2FA 时，服务商生成一个唯一的密钥，同时存储在你的设备和服务端。', howStep2: '基于时间的验证码', howStep2Desc: '你的设备和服务端各自用「密钥 + 当前时间」独立计算出一个 6 位验证码（RFC 6238）。', howStep3: '30 秒有效期', howStep3Desc: '验证码每 30 秒自动刷新一次，双方必须保持时间同步（UTC）。', howStep4: '验证匹配', howStep4Desc: '你输入设备上显示的验证码，服务端自行计算并比对——一致则放行。', securityNote: '你的密钥不会离开浏览器，所有计算均在本地通过 Web Crypto API 完成。' },
      en: { secretKey: 'Secret Key', addAccount: 'Add Account', accountName: 'Account Name', issuer: 'Issuer', placeholder: 'Paste TOTP secret or otpauth:// URI…', countdown: 'Countdown', copyCode: 'Copy Code', delete: 'Delete', showCode: 'Show Code', hideCode: 'Hide Code', setupGuide: 'Setup Guide', step1: 'Go to account security settings', step1Desc: 'Log in to the service and find the security settings page.', step2: 'Select "Authenticator App"', step2Desc: 'Choose "Authenticator App" as verification method, a QR code or secret key will be shown.', step3: 'Import QR code or secret', step3Desc: 'Save the QR code image and drag it below; or click "Can\'t scan QR code" and paste the Base32 key.', step4: 'View verification code', step4Desc: 'A 6-digit code is generated automatically after import, refreshing every 30 seconds.', services: 'Popular Services', history: 'History', importQr: 'Import from QR code image', qrHint: 'Drop image, click to select, or paste (Ctrl+V)', scanning: 'Scanning QR code...', orText: 'OR', conceptTitle: 'Concepts', whatIs2fa: 'What is 2FA?', whatIs2faDesc: 'Two-Factor Authentication adds a second layer of security beyond your password. Even if someone steals your password, they cannot access your account without the time-based verification code.', howItWorks: 'How TOTP Works', howStep1: 'Shared Secret', howStep1Desc: 'When you enable 2FA, the service generates a unique secret key shared between you and the server.', howStep2: 'Time-Based Code', howStep2Desc: 'Both your device and the server independently compute a 6-digit code using the secret key + current time (RFC 6238).', howStep3: '30-Second Window', howStep3Desc: 'The code changes every 30 seconds. Both sides must agree on the current time (UTC).', howStep4: 'Verification', howStep4Desc: 'You enter the code shown on your device. The server computes its own code and compares — if they match, access is granted.', securityNote: 'Your secret key never leaves your browser. All computation happens locally using the Web Crypto API.' },
    },
    help: {
  ...
  // ── disease ──
  disease: {
    name: { zh: '传染病追踪', en: 'Disease Outbreak Tracker' },
    desc: { zh: '实时追踪全球传染病疫情动态，来源 WHO 官方数据，含预防指南和物资准备清单', en: 'Real-time global disease outbreak tracking from WHO, with prevention guide and preparation checklist' },
    ui: {
      zh: { covidGlobal: 'COVID-19 全球数据', totalCases: '累计确诊', totalDeaths: '死亡', recovered: '治愈', todayCases: '今日新增', updated: '更新时间', outbreakNews: 'WHO 疫情通报', whoNews: 'WHO 最新消息', refresh: '刷新', loading: '加载中...', noData: '暂无数据', viewInfo: '查看资料', diseaseInfo: '疾病百科', symptoms: '主要症状', prevention: '预防措施', prepChecklist: '防疫物资准备清单', search: '搜索...', locations: '地点', spread: '扩散情况', cases: '感染', deaths: '死亡', typeTag: '类型' },
      en: { covidGlobal: 'COVID-19 Global', totalCases: 'Total Cases', totalDeaths: 'Deaths', recovered: 'Recovered', todayCases: 'Today', updated: 'Updated', outbreakNews: 'WHO Disease Outbreak News', whoNews: 'WHO Latest News', refresh: 'Refresh', loading: 'Loading...', noData: 'No data available', viewInfo: 'View Info', diseaseInfo: 'Disease Encyclopedia', symptoms: 'Key Symptoms', prevention: 'Prevention Measures', prepChecklist: 'Preparation Checklist', search: 'Search...', locations: 'Location', spread: 'Spread', cases: 'Cases', deaths: 'Deaths', typeTag: 'Type' },
    },
    help: {
      zh: { title: '使用说明', features: ['实时获取 WHO 疫情通报数据', 'COVID-19 全球统计数据', 'WHO 最新健康新闻', '11 种近期高频传染病百科（症状 + 预防）', '疫情卡片自动识别疾病类型标签', '防疫物资准备清单（可勾选）', '数据自动缓存 30 分钟'], usage: ['查看 WHO 疫情通报了解最新疫情动态', '点击疫情卡片上的疾病类型标签，快速查看右侧疾病资料', '在疾病百科中选择想了解的传染病', '展开物资准备清单，勾选已准备的项目', '点击刷新按钮获取最新数据'] },
      en: { title: 'Usage Guide', features: ['Real-time WHO Disease Outbreak News', 'COVID-19 global statistics', 'WHO latest health news', '11 recent high-frequency disease encyclopedia entries (symptoms + prevention)', 'Automatic disease type tags on outbreak cards', 'Preparation checklist with checkboxes', 'Data cached for 30 minutes'], usage: ['Check WHO outbreak news for latest developments', 'Click the disease type tag on an outbreak card to open the matching disease details', 'Select a disease from the encyclopedia', 'Expand preparation checklist and check off items', 'Click refresh for latest data'] },
    },
  },
  // ── website screenshot ──
  websiteScreenshot: {
